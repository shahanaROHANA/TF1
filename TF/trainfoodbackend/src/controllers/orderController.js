...
export const createOrder = async (req, res) => {
  try {
    ...
    // Reserve stock (optional - you could implement proper inventory locking)
    for (const item of items) {
    ...
    if (paymentMethod !== 'COD') {
      response.clientSecret = (await stripe.paymentIntents.retrieve(paymentData.gatewayId)).client_secret;
    }
...
export const assignOrder = async (req, res) => {
  try {
    ...
    order.assignedDriver = agent._id;
